...
import { setTotalAmount } from 'global.js'; // Упрощенный импорт
...
const CheckoutSummary = async () => {
  ...
  setTotalAmount(total); // Устанавливаем значение глобальной переменной
    ...
    <div className="sticky top-0 flex flex-col-reverse small:flex-col gap-y-8 py-8 small:py-0">
      <div className="w-full bg-white flex flex-col">
        ...
        <div className="mt-6">
          ...
          <form action="http://localhost:5000/generate_link" method="POST">
